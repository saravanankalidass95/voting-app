...
class ShowIdeaTest extends TestCase
{
    ...
    public function list_of_ideas_shows_on_main_page()
    {
        ...
        $statusOpening = Status::factory()->create(['name' => 'Open' ,'classes' => 'bg-gray-200']);
        ...
        $response->assertsee($catagoryOne->name);
        ...
        $response->assertsee($catagoryTwo->name);
    ...
    public function in_app_back_button_works_when_index_page_visited_first()
    {
        ...
        $response = $this->get('/?catagory=Catagory%202&status=Considering');
        $response = $this->get(route('idea.show', $ideaOne));

        $this->assertStringContainsString('/?catagory=Catagory%202&status=Considering', $response['backUrl']);
    }
