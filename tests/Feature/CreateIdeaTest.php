...
class CreateIdeaTest extends TestCase
{
    ...
    public function create_idea_form_does_not_show_when_logged_out()
    {
        ...
        $response->assertSee('Plese login to create an idea.');
        $response->assertDontSee(' Let us know what you whould like and we\'ll take a look over!');
    }
    ...
    public function create_idea_form_does_show_when_logged_in()
    {
        ...
        $response->assertSuccessful();
        $response->assertDontSee('Plese login to create an idea.');
        $response->assertSee(' Let us know what you whould like and we\'ll take a look over!', false);
    }
    ...
    public function creating_an_idea_works_correctly()
    {
        ...
        $categoryOne = Catagory::factory()->create(['name' => 'Catagory 1']);
        $categoryTwo = Catagory::factory()->create(['name' => 'Catagory 2']);
