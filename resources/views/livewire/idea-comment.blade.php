    ...
    <div class="flex flex-col md:flex-row flex-1 px-4 py-6">
        ...
        <div class="w-full md:mx-4">
            <div class="text-gray-600">
                @admin
                    @if($comment->spam_report > 0)
                        <div class="text-red mb-2">Spam Reports: {{ $comment->spam_report }}</div>
                    @endif
                @endadmin
            ...
            <div class="flex items-center justify-between mt-6">
                <div class="flex items-center text-xs text-gray-400 font-semibold space-x-2">
                    ...
                    <div class="@if($comment->is_status_update) text-blue @endif text-gray-700 font-bold">{{ $comment->user->name }}</div>
                    <div>&bull;</div>
                ...
                >
                    <div class="relative">
                        ...
                        <ul
                            class="absolute w-44 text-left font-semibold bg-white border shadow-dialog rounded-xl z-10 py-3 md:ml-8 top-8 md:top-6 right-0 md:left-0"
                            x-cloak
