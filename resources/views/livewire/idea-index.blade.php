<div 
    ...
    class="idea-container hover:shadow-card bg-white transition duration-150 ease-in rounded-xl flex cursor-pointer"
>
    ...
    <div class="flex flex-col md:flex-row flex-1 px-2 py-6">
        <div class="flex-none mx-2 md:mx-0"><a href="#">
                ...
                <div class="flex items-center md:hidden mt-4 md:mt-0">
                    ...
                    @if($hasVoted)
                        <button
                            ...
                            class="w-20 bg-blue text-white border border-blue hover:bg-blue-hover font-bold 
                    ...
                    @else
                        <button
                            wire:click.prevent="vote"
                            class="w-20 bg-gray-200 border hover:bg-blue-hover font-bold 
                            text-xxs uppercase rounded-xl transition 
