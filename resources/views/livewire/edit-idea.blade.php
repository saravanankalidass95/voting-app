  ...
  <div class="fixed inset-0 z-10 overflow-y-auto">
    <div class="flex min-h-full items-end justify-center">
      ...
      <div 
        ...
        class="model relative transform overflow-hidden rounded-tl-xl rounded-tr-xl bg-white transition-all py-4 sm:w-full sm:max-w-lg"
      >
        ...
        <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
            ...
            <form wire:submit.prevent="updateIdea" action="#" method="POST" class="space-y-4 px-4 py-6">
                <div>
                    <input wire:model.defer="title" x-ref="title" type="text" class="w-full bg-gray-100 text-sm border-none rounded-xl placeholder-gray-900 px-4 py-2" placeholder="Your Idea" required>
                    @error('title')
