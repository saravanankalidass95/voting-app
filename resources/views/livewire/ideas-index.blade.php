<div>
    <div class="filters flex flex-col md:flex-row space-y-3 md:space-y-0 md:space-x-6">
        <div class="w-full md:w-1/3">
            <select wire:model="catagory" name="category" id="category" class="w-full rounded-xl rounded-xl border-none px-4 py-2">
        ...
        <div class="w-full md:w-1/3">
            <select wire:model="filter" name="other_filters" id="other_filters" class="w-full rounded-xl rounded-xl border-none px-4 py-2">
    ...
    <div class="ideas-container space-y-6 my-8">
        ...
        @empty
            <div class="mx-auto w-70 mt-12">
                ...
                <div class="class text-gray-400 text-center font-bold mt-6">No ideas were found....</div>
